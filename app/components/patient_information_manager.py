...
if __name__ == "__main__":
    ...
    # even if some are left empty for now.
    sample_raw_data = {
        "working_diagnosis": "Rotator Cuff Tendinopathy",
        "age": 47,
        "sex": "Female",
        ...
        "pain_behavior": "",
        "symptoms": ["Night pain", "Difficulty reaching overhead"],
    ...
    patient_profile = manager.process(sample_raw_data)

    print("Component 1 ran successfully!")
